            ...
            <form method="POST" action="{{ route('admin.patients.store') }}" id="patientForm">
                ...
                <div class="row">
                    <div class="col-md-3 mb-2">
                     ...
                     <div class="col-md-3 mb-2" style="position: relative;">
                        ...
                        <input type="text" class="form-control @error('village') is-invalid @enderror" id="village" name="village" value="{{ old('village') }}" required autocomplete="off" placeholder="Type to search...">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="text" class="form-control @error('mobile') is-invalid @enderror" id="mobile" name="mobile" value="{{ old('mobile') }}" pattern="[0-9]{10}" placeholder="10-digit">
                        @error('mobile')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-5 mb-2">
                        ...
                        <input type="text" class="form-control @error('aadhar') is-invalid @enderror" id="aadhar" name="aadhar" value="{{ old('aadhar') }}" pattern="[0-9]{12}" placeholder="12-digit">
                        @error('aadhar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div id="vital_signs_section">
                    ...
                    <div class="col-md-3 mb-2" id="bp_field">
                        ...
                        <input type="text" class="form-control @error('bp') is-invalid @enderror" id="bp" name="bp" value="{{ old('bp') }}" placeholder="120/80">
                        @error('bp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2" id="bmi_field">
                            ...
                            <input type="number" step="0.01" class="form-control" id="bmi_display" value="{{ old('bmi') }}" disabled readonly>
                ...
                <div id="clinical_section">
                    ...
                    <div class="mb-2" id="complaints_field">
                        ...
                        <input type="hidden" name="complaints" id="complaints_hidden" value="{{ old('complaints') }}">
                        @error('complaints')
                    ...
                    <div class="mb-2" id="known_conditions_field">
                        ...
                        <input type="hidden" name="known_conditions" id="known_conditions_hidden" value="{{ old('known_conditions') }}">
                    ...
                    <div class="mb-2" id="diagnosis_field">
                        ...
                        <input type="hidden" name="diagnosis" id="diagnosis_hidden" value="{{ old('diagnosis') }}">
                        @error('diagnosis')
                            <div class="invalid-feedback" style="display: block;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-2" id="investigation_field">
                        ...
                        <textarea class="form-control @error('investigation') is-invalid @enderror" id="investigation" name="investigation" rows="2">{{ old('investigation') }}</textarea>
                        @error('investigation')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-2" id="advice_field">
                        ...
                        <textarea class="form-control @error('advice') is-invalid @enderror" id="advice" name="advice" rows="2">{{ old('advice') }}</textarea>
                        @error('advice')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div id="treatment_section">
                    ...
                    <div class="mb-2" id="treatment_field">
                        ...
                        <textarea class="form-control @error('treatment') is-invalid @enderror" id="treatment" name="treatment" rows="2">{{ old('treatment') }}</textarea>
                        @error('treatment')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-2" id="dosage_field">
                        ...
                        <textarea class="form-control @error('dosage') is-invalid @enderror" id="dosage" name="dosage" rows="2">{{ old('dosage') }}</textarea>
                        @error('dosage')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div id="lab_referral_section">
                    ...
                    <div class="row" id="sample_collected_field">
                        ...
                        <div class="col-md-4 mb-2" id="referral_type_field">
                            ...
                            <input type="text" class="form-control @error('referral_type') is-invalid @enderror" id="referral_type" name="referral_type" value="{{ old('referral_type') }}" placeholder="e.g., Specialist">
                            @error('referral_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
