...
unset($__errorArgs, $__bag); ?>" id="village" name="village" value="<?php echo e(old('village')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="mobile" name="mobile" value="<?php echo e(old('mobile')); ?>" pattern="[0-9]{10}" placeholder="10-digit number" required>
...
unset($__errorArgs, $__bag); ?>" id="aadhar" name="aadhar" value="<?php echo e(old('aadhar')); ?>" pattern="[0-9]{12}" placeholder="12-digit number">
...
unset($__errorArgs, $__bag); ?>" id="bp" name="bp" value="<?php echo e(old('bp')); ?>" placeholder="e.g., 120/80">
                        <?php $__errorArgs = ['bp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="bmi" name="bmi" value="<?php echo e(old('bmi')); ?>">
                            <?php $__errorArgs = ['bmi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="complaints" name="complaints" rows="3"><?php echo e(old('complaints')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="known_conditions" name="known_conditions" rows="3"><?php echo e(old('known_conditions')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="diagnosis" name="diagnosis" rows="3"><?php echo e(old('diagnosis')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="investigation" name="investigation" rows="3"><?php echo e(old('investigation')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="advice" name="advice" rows="3"><?php echo e(old('advice')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="treatment" name="treatment" rows="3"><?php echo e(old('treatment')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="dosage" name="dosage" rows="3"><?php echo e(old('dosage')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="referral_type" name="referral_type" value="<?php echo e(old('referral_type')); ?>" placeholder="e.g., Specialist, Hospital">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u756840116/domains/pink-spider-206461.hostingersite.com/public_html/resources/views/admin/patients/create.blade.php ENDPATH**/ ?>