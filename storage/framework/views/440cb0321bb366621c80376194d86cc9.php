...
unset($__errorArgs, $__bag); ?>" id="height" name="height" value="<?php echo e(old('height', $patient->height)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="weight" name="weight" value="<?php echo e(old('weight', $patient->weight)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="hb" name="hb" value="<?php echo e(old('hb', $patient->hb)); ?>">
                        <?php $__errorArgs = ['hb'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="rbs" name="rbs" value="<?php echo e(old('rbs', $patient->rbs)); ?>">
                            <?php $__errorArgs = ['rbs'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="bsl" name="bsl" value="<?php echo e(old('bsl', $patient->bsl)); ?>">
                            <?php $__errorArgs = ['bsl'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row" id="bmi_field">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="bmi_display" value="<?php echo e(old('bmi', $patient->bmi)); ?>" disabled readonly>
                            <!-- Hidden input to store BMI for form submission -->
                            <input type="hidden" id="bmi" name="bmi" value="<?php echo e(old('bmi', $patient->bmi)); ?>">
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" style="display: none;">
                        ...
                        <input type="hidden" name="complaints" id="complaints_hidden" value="<?php echo e(old('complaints', $patient->complaints)); ?>">
...
unset($__errorArgs, $__bag); ?>" style="display: none;">
                        ...
                        <input type="hidden" name="known_conditions" id="known_conditions_hidden" value="<?php echo e(old('known_conditions', $patient->known_conditions)); ?>">
...
unset($__errorArgs, $__bag); ?>" style="display: none;">
                        ...
                        <input type="hidden" name="diagnosis" id="diagnosis_hidden" value="<?php echo e(old('diagnosis', $patient->diagnosis)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="topic_covered" name="topic_covered" value="<?php echo e(old('topic_covered', $patient->topic_covered)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="investigation" name="investigation" rows="3"><?php echo e(old('investigation', $patient->investigation)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="advice" name="advice" rows="3"><?php echo e(old('advice', $patient->advice)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="treatment" name="treatment" rows="3"><?php echo e(old('treatment', $patient->treatment)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="dosage" name="dosage" rows="3"><?php echo e(old('dosage', $patient->dosage)); ?></textarea>
                ...
                <div id="lab_referral_section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="lab_tests[]" value="Blood Test" id="labBlood" <?php echo e(in_array('Blood Test', $labTests) ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="labBlood">Blood Test</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="lab_tests[]" value="Urine Test" id="labUrine" <?php echo e(in_array('Urine Test', $labTests) ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="labUrine">Urine Test</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="lab_tests[]" value="X-Ray" id="labXray" <?php echo e(in_array('X-Ray', $labTests) ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="labXray">X-Ray</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="lab_tests[]" value="ECG" id="labECG" <?php echo e(in_array('ECG', $labTests) ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="labECG">ECG</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="lab_tests[]" value="Ultrasound" id="labUSG" <?php echo e(in_array('Ultrasound', $labTests) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="sample_collected" name="sample_collected">
                                <option value="">-- Select --</option>
                                <option value="Yes" <?php echo e(old('sample_collected', $patient->sample_collected) == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                                <option value="No" <?php echo e(old('sample_collected', $patient->sample_collected) == 'No' ? 'selected' : ''); ?>>No</option>
                                <option value="NA" <?php echo e(old('sample_collected', $patient->sample_collected) == 'NA' ? 'selected' : ''); ?>>N/A</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" id="referral_type" name="referral_type" value="<?php echo e(old('referral_type', $patient->referral_type)); ?>" placeholder="e.g., Specialist, Hospital">
...
unset($__errorArgs, $__bag); ?>" id="referral_details" name="referral_details" rows="2"><?php echo e(old('referral_details', $patient->referral_details)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="notes" name="notes" rows="3"><?php echo e(old('notes', $patient->notes)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tech\borderless\borderless\resources\views/admin/patients/edit.blade.php ENDPATH**/ ?>