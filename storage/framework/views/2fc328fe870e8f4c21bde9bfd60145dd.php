...
<?php $__env->startSection('page-title', 'Edit Complaint'); ?>
...
<div class="table-container">
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.complaints.update', $complaint->id)); ?>" id="complaintForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                  ...
                                  required><?php echo e(old('complaint', $complaint->complaint)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tech\borderless\borderless\resources\views/admin/complaints/edit.blade.php ENDPATH**/ ?>