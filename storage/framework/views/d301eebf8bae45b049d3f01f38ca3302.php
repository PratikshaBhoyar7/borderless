...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row" id="bmi_field">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control <?php $__errorArgs = ['bmi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="bmi" name="bmi" value="<?php echo e(old('bmi', $patient->bmi)); ?>">
                            <?php $__errorArgs = ['bmi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="clinical_section">
                    ...
                    <div class="mb-3" id="complaints_field">
                        ...
                        <textarea class="form-control <?php $__errorArgs = ['complaints'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="complaints" name="complaints" rows="3"><?php echo e(old('complaints', $patient->complaints)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3" id="known_conditions_field">
                        ...
                        <textarea class="form-control <?php $__errorArgs = ['known_conditions'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="known_conditions" name="known_conditions" rows="3"><?php echo e(old('known_conditions', $patient->known_conditions)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="diagnosis" name="diagnosis" rows="3"><?php echo e(old('diagnosis', $patient->diagnosis)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u756840116/domains/pink-spider-206461.hostingersite.com/public_html/resources/views/admin/patients/edit.blade.php ENDPATH**/ ?>